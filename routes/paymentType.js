...
router.get(process.env.BASE_API + PaymentTypeController.api + '/get', auth.isAuthenticated, function(req, res){
...
router.getAll(process.env.BASE_API + PaymentTypeController.api + '/getAll', auth.isAuthenticated, function(req, res){
...
router.post(process.env.BASE_API + PaymentTypeController.api + '/save', auth.isAuthenticated, function(req, res){
   var data = req.body;
...
router.delete(process.env.BASE_API + PaymentTypeController.api + '/delete', auth.isAuthenticated, function(req, res){
