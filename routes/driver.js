...
router.get(process.env.BASE_API + DriverController.api + '/get', auth.isAuthenticated, function(req, res){
...
router.getAll(process.env.BASE_API + DriverController.api + '/getAll', auth.isAuthenticated, function(req, res){
...
router.post(process.env.BASE_API + DriverController.api + '/save', auth.isAuthenticated, function(req, res){
   var data = req.body;
...
router.delete(process.env.BASE_API + DriverController.api + '/delete', auth.isAuthenticated, function(req, res){
